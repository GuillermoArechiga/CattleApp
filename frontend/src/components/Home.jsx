    ...
    <div className="bg-gradient-to-r from-gray-100 to-gray-200 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-center">
          {/* Koa.js Card */}
          <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg shadow-md p-6 transition duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          {/* GraphQL Card */}
          <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg shadow-md p-6 transition duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          {/* Apollo Card */}
          <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-lg shadow-md p-6 transition duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          {/* React Card */}
          <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-lg shadow-md p-6 transition duration-300 transform hover:scale-105 hover:shadow-lg">
          ...
          {/* MongoDB Card */}
          <div className="bg-gradient-to-br from-red-100 to-red-200 rounded-lg shadow-md p-6 transition duration-300 transform hover:scale-105 hover:shadow-lg">
